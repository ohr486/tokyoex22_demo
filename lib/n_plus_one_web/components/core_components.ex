defmodule NPlusOneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NPlusOneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NPlusOneWeb.Gettext, "errors", msg, opts)
    end
  end
